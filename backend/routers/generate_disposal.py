...
from schemas import GenerateDisposalRequest, GenerateDisposalResponse
...
@router.post("/", response_model=GenerateDisposalResponse)
async def generate_disposal(req: GenerateDisposalRequest) -> GenerateDisposalResponse:
    ...
    try:
        ...
        return GenerateDisposalResponse(
